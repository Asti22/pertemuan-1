                    ...
                    <div class="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                Update details for <span class="font-bold text-indigo-500">"{{ $product->name }}"</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <form action="{{ route('product.update', $product->id) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $product->name) }}" 
                                ...
                                {{ $errors->has('name') ? 'border-red-500 ring-2 ring-red-500/50 bg-red-50/50 dark:bg-red-900/30' : 'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700' }} 
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="quantity" name="quantity" value="{{ old('quantity', $product->quantity) }}"
                                    class="w-full px-4 py-2.5 rounded-lg border text-sm transition focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent 
                                    {{ $errors->has('quantity') ? 'border-red-500 ring-2 ring-red-500/50 bg-red-50/50 dark:bg-red-900/30' : 'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700' }} 
                            ...
                            <div>
                                ...
                                <input type="number" id="price" name="price" value="{{ old('price', $product->price) }}" step="0.01"
                                    class="w-full px-4 py-2.5 rounded-lg border text-sm transition focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent 
                                    {{ $errors->has('price') ? 'border-red-500 ring-2 ring-red-500/50 bg-red-50/50 dark:bg-red-900/30' : 'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700' }} 
                                    text-gray-900 dark:text-gray-100">
                                @error('price')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-400 font-bold">
                                        ⚠️ {{ $message }}
                        ...
                        <div>
                            ...
                            <select id="user_id" name="user_id" 
                                class="w-full px-4 py-2.5 rounded-lg border text-sm transition focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent 
                                {{ $errors->has('user_id') ? 'border-red-500 ring-2 ring-red-500/50 bg-red-50/50 dark:bg-red-900/30' : 'border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700' }} 
                                text-gray-900 dark:text-gray-100">
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-gray-100 dark:border-gray-700">
                            <button type="button" 
                                ...
                                class="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-bold text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 rounded-lg transition">
