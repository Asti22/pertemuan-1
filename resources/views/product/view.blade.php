                ...
                <div class="p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <div class="flex items-center gap-2">
                            <a href="{{ route('product.edit', $product->id) }}" class="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-medium rounded-lg border border-amber-600 text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-900/30 transition">
                            ...
                            <form action="{{ route('product.delete', $product->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this product?')">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-medium rounded-lg border border-red-600 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/30 transition">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="rounded-lg border border-gray-200 dark:border-gray-700 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <div class="flex items-center px-6 py-4">
                            <div class="w-32 shrink-0 text-sm font-medium text-gray-500 dark:text-gray-400">Product Name</div>
                        ...
                        {{-- Price --}}
                        <div class="flex items-center px-6 py-4">
                            <div class="w-32 shrink-0 text-sm font-medium text-gray-500 dark:text-gray-400">Price</div>
                        ...
                        {{-- Owner --}}
                        <div class="flex items-center px-6 py-4">
                            <div class="w-32 shrink-0 text-sm font-medium text-gray-500 dark:text-gray-400">Owner</div>
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm text-gray-600 dark:text-gray-300">{{ $product->user->name ?? '-' }}</span>
                            </div>
                        </div>

                        {{-- Created At --}}
                        <div class="flex items-center px-6 py-4">
                            <div class="w-32 shrink-0 text-sm font-medium text-gray-500 dark:text-gray-400">Created At</div>
                        ...
                        {{-- Updated At --}}
                        <div class="flex items-center px-6 py-4">
                            <div class="w-32 shrink-0 text-sm font-medium text-gray-500 dark:text-gray-400">Updated At</div>
                            <div class="text-sm text-gray-600 dark:text-gray-300">
